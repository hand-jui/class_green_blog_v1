...
public class RestExceptionHandler {
	...
	public String constrainViolationException(ConstraintViolationException e) {
...
//					ExceptionFieldMessage.builder().field(fieldName)
...
//	}
	...
	public ApiErrorResponse methodArgumentNotValidException(MethodArgumentNotValidException e) {
		...
		e.getBindingResult().getAllErrors().forEach(action -> {
			...
			ExceptionFieldMessage exceptionFieldMessage = ExceptionFieldMessage.builder().field(fieldName)
					.message(message).build();
